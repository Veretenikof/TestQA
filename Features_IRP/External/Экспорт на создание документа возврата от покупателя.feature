...
@ExportScenarios
@IgnoreOnCIMainBuild
Функционал: Создание документа возврата от покупателя

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Создание документа возврата от покупателя
	...
	И я проверяю или создаю для справочника "RowIDs" объекты:
		...
		| 'e1cib/data/Catalog.RowIDs?ref=9578cafb2ec0c39411f10235195c25b6' | 'False'        | 41     | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb76684b9f6867' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7674324a4a2a' | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d794b' | 'True'                 | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6861' | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb76684b9f687e' | ''       | 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | ''                  | ''            | ''              | ''                  | 'Enum.GoodsReceiptTransactionTypes.ReturnFromCustomer' | ''                | ''          | ''                   | ''                 | ''                   | 'False'                    | ''                  |
	...
	И я проверяю или создаю для документа "SalesReturn" объекты:
		...
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'False'        | 2        | '05.02.2026 12:12:04' | 'True'   | 'e1cib/data/Catalog.Agreements?ref=b762b13668d0905011eb76684b9f6867' | ''             | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7663e35d7964' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | '01.01.0001 0:00:00' | 'e1cib/data/Catalog.Companies?ref=b762b13668d0905011eb7674324a4a2a' | ''               | 'e1cib/data/Catalog.Partners?ref=b762b13668d0905011eb7663e35d794b' | 'True'            | 'False'        | ''                  | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | ''       | ''            | 421990           |
	...
	И я перезаполняю для объекта табличную часть "ItemList":
		...
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | 'False'  | 'e1cib/data/Catalog.ItemKeys?ref=b762b13668d0905011eb76684b9f687e' | 'e1cib/data/Catalog.Stores?ref=b762b13668d0905011eb76684b9f6861' | 351658.33   |                | 190     | 'e1cib/data/Catalog.PriceTypes?ref=b762b13668d0905011eb76684b9f6866' | 2221       | 70331.67    | 421990        | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | ''                 | ''             | 'False'            | 2221                 | ''                 | ''            | ''                   | 'True'            | ''             |
	...
	И я перезаполняю для объекта табличную часть "TaxList":
		...
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | 'e1cib/data/Catalog.Taxes?ref=b762b13668d0905011eb7663e35d7970' | 70331.67 | ''          | 'e1cib/data/Catalog.TaxRates?ref=b762b13668d0905011eb7663e35d796c' | 'True'                 | 70331.67       |

	И я перезаполняю для объекта табличную часть "Currencies":
		| 'Ref'                                                                  | 'CurrencyFrom'                                                       | 'Rate' | 'ReverseRate' | 'ShowReverseRate' | 'Multiplicity' | 'Key' | 'MovementType'                                                                                    | 'Amount'  | 'IsFixed' |
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796b' | 421990    | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 0.859  | 1.1641        | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d796a' | 362489.41 | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' | 1      | 1             | 'False'           | 1              | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7968' | 421990    | 'False'   |
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'e1cib/data/Catalog.Currencies?ref=b762b13668d0905011eb7663e35d795e' |        |               | 'False'           |                | ''    | 'e1cib/data/ChartOfCharacteristicTypes.CurrencyMovementType?ref=b762b13668d0905011eb7663e35d7969' |           | 'False'   |

	И я перезаполняю для объекта табличную часть "RowIDInfo":
		| 'Ref'                                                                  | 'Key'                                  | 'RowID'                                | 'Quantity' | 'Basis' | 'CurrentStep' | 'NextStep'                                    | 'RowRef'                                                         | 'BasisKey' |
		| 'e1cib/data/Document.SalesReturn?ref=9578cafb2ec0c39411f10235195c25b7' | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | 'b2b4ae05-ed03-413f-974b-6e47d8bbbbc9' | 2221       | ''      | ''            | 'e1cib/data/Catalog.MovementRules?refName=GR' | 'e1cib/data/Catalog.RowIDs?ref=9578cafb2ec0c39411f10235195c25b6' | ''         |
