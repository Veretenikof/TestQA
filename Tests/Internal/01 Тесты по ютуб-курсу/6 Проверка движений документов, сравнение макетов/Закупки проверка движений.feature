...
Сценарий: Ввод поступления товаров
	...
	* Проверка движения документа
		*Взаиморасчеты
			...
			И в таблице "Список" количество строк "меньше или равно" 1 Тогда
		...
		*Остатки
			...
			И в таблице "Список" количество строк "меньше или равно" 2 Тогда
			И таблица "Список" содержит строки из макета "Примеры-макеты\Закупки_Движения_1.mxl" по шаблону
